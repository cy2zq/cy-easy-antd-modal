...
} from 'cy-easy-antd-modal';
import { DragModal, Drawer, EasyAntdModalProvider, Modal } from 'cy-easy-antd-modal';
...
export default () => (
  <>
    ...
    <Modal title="cy-easy-antd-modal" trigger={<Button type="primary">Modal</Button>}>
      I ❤️ antd
    </Modal>
    ...
    <Drawer title="cy-easy-antd-modal" trigger={<Button type="primary">Drawer</Button>}>
      I ❤️ antd
    </Drawer>
    ...
    <DragModal title="cy-easy-antd-modal" trigger={<Button type="primary">DragModal</Button>}>
      I ❤️ antd
    </DragModal>
